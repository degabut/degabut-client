...
export const Drawer: ParentComponent<Props> = (props) => {
	return (
		<div class={`h-full absolute md:static top-0 z-50 ${props.extraContainerClass}`}>
			{props.isOpen && (
				<div
					class="block md:hidden fixed w-screen h-screen top-0 left-0 bg-black bg-opacity-80 -z-10"
